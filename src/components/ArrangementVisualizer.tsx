            ...
            return (
              ...
              >
                <button
                  ...
                  `}
                  style={{ 
                    clipPath: typeof heightValue === 'object' 
                      ? `polygon(0% ${100 - heightValue.start}%, 0% 100%, 100% 100%, 100% ${100 - heightValue.end}%)`
                      : `polygon(0% ${100 - (heightValue as number / maxHeight * 100)}%, 0% 100%, 100% 100%, 100% ${100 - (heightValue as number / maxHeight * 100)}%)`,
